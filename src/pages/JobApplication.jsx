  ...
  const handleJobSubmit = async (data) => {
    ...
    try {
      ...
      const response = await axios.post(
        `https://jobme-server-ntj9.onrender.com/api/v1/jobs/apply/${jobId}`,
        formData,
        {
          headers: {
    ...
    <div>
      <Layout>
        ...
        >
          ...
          >
            <ToastContainer className={"position-absolute"} autoClose={5000} position="bottom-right"  />
            ...
            <MyButton content={isSubmitting ? "Applying...": "Apply Now"} extraClass={"p-2 rounded-4"} />
          </form>
        </div>
      </Layout>
    </div>
